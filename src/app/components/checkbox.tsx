...
export function Checkbox(props: Props) {
  ...
  return (
    <ArkCheckbox.Root {...rest} className={cn("flex items-center gap-1")}>
      <ArkCheckbox.Control
        className={cn(
          "inline-flex h-5 w-5 cursor-pointer items-center justify-center rounded-xs border border-[#E9E8E6] transition-colors hover:bg-[#EFEEEC] data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 data-[disabled]:hover:bg-transparent",
          {
