  ...
  return (
    <ArkCombobox.Control className="relative flex items-center">
      <ArkCombobox.Input {...props} asChild>
        <Input variant={variant} size={size} className="pe-16" />
      </ArkCombobox.Input>
    ...
    <Portal>
      <ArkCombobox.Positioner>
        <ArkCombobox.Content
          {...rest}
          className={cn(
            "border-border-subtle bg-bg-default z-[calc(50+var(--layer-index))] max-h-96 overflow-y-auto rounded-lg border p-2 shadow-2xs outline-0",
            className,
          )}
        />
      </ArkCombobox.Positioner>
