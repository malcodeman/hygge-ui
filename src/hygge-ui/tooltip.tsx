      ...
      {content ? (
        <Portal>
          <ArkTooltip.Positioner>
            <ArkTooltip.Content className="z-[calc(50+var(--layer-index))] max-w-xs rounded-lg bg-[#191918] p-2 text-xs font-semibold text-[#eeeeec] shadow-2xs outline-0 dark:bg-white dark:text-[#21201C]">
              {showArrow ? (
